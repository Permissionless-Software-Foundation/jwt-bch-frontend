          ...
          <div className='grid-wrapper'>
            ...
            <div className='col-12'>
              <p>
                ...
                the <a href='https://psfoundation.cash' target='_blank' rel='noreferrer'>Permissionless
                  Software Foundation
                    </a>, a network of independent developers
          ...
          <div className='grid-wrapper' style={{ border: 'solid 1px black', marginTop: '25px' }}>
            ...
            <div className='col-6' style={{ padding: '20px' }}>
              <p>
                ...
                developing <a href='https://cashstack.info' target='_blank' rel='noreferrer'>infrastructure</a> and
                the <a href='https://psfoundation.info' target='_blank' rel='noreferrer'>software maintained by the PSF</a>.
              </p>
              <p>
		...
		allows you to display goods, and allows customers to pay in Bitcoin Cash or tokens.
          ...
          <div className='grid-wrapper'>
            ...
            <div className='col-12'>
              ...
              <ul>
                <li>
                  <a href='https://christroutner.github.io/trouts-blog/blog/managing-app-development/' target='_blank' rel='noreferrer'>
                    Managing App Development
                  </a>.
                </li>
                <li>
                  <a href='https://christroutner.github.io/trouts-blog/blog/product-owner-roles' target='_blank' rel='noreferrer'>
                    Product Owner: Roles & Responsibilities
                  </a>.
                </li>
                <li>
                  <a href='https://christroutner.github.io/trouts-blog/blog/software-development-process' target='_blank' rel='noreferrer'>
