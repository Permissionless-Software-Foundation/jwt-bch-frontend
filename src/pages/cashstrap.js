    ...
    return (
      <Layout>
        ...
        <section id='three' className='main style1 special'>
          <div className='grid-wrapper'>
            <div className='col-12'>
              ...
              <p>
                Below are links to Docker containers and pre-synced databases for the Bitcoin Cash (BCH) blockchain.
              </p>
            </div>
          </div>
          <div className='grid-wrapper' style={{ border: 'solid 1px black' }}>
            <div className='col-6' style={{ padding: '20px' }}>
              <span className='image fit'><img src={bchn} alt='' /> <h3>Full Node Blockchain</h3></span>
            </div>
            <div className='col-6' style={{ padding: '20px' }}>
              <h3>BCH</h3>
          ...
          <div className='grid-wrapper' style={{ border: 'solid 1px black', marginTop: '25px' }}>
            <div className='col-6' style={{ padding: '20px' }}>
              <span className='image fit'><center> <img src={fulcrum} alt='fulcrum' style={{ width: '50%' }} /> </center> <h3>Fulcrum ElectrumX Indexer</h3></span>
            </div>
            <div className='col-6' style={{ padding: '20px' }}>
              <h3>BCH</h3>
              <ul style={{ textAlign: 'left' }}>
        ...
        <section id='three' className='main style1 special'>
          ...
          <div className='grid-wrapper' style={{ border: 'solid 1px black' }}>
            <div className='col-6' style={{ padding: '20px' }}>
              <span className='image fit'><img src={bitcoinAbc} alt='' /> <h3>Full Node Blockchain</h3></span>
            </div>
            <div className='col-6' style={{ padding: '20px' }}>
              <h3>eCash</h3>
              <ul style={{ textAlign: 'left' }}>
        ...
        <section id='four' className='main style2 special'>
          <div className='container'>
            ...
            <ul className='actions uniform'>
              <li>
                <a href='/login' className='button special'>Sign Up</a>
              </li>
              <li>
