        ...
        <section id="three" className="main style1 special">
          ...
          <div className="grid-wrapper" style={{ border: 'solid 1px black', marginTop: '25px' }}>
            ...
            <div className="col-6" style={{ padding: '20px' }}>
              ...
              <p>
                This is our open source, white-label wallet. It provides a foundation
                upon which to build additional functionality. We encourage developers
                and businesses to fork this code base and customize it for their
                own needs.
              </p>
              <p>
                This wallet app provides the following basic functionality:
              </p>
              <ul>
              ...
              <ul className="actions">
                <li>
                  <a href="https://bchn-wallet.fullstack.cash" target="_blank" className="button">
                    Live Demo
                  </a>
                </li>
              </ul>
